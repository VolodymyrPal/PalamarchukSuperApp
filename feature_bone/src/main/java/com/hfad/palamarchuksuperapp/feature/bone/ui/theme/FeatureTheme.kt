...
fun financeStatusColor(
    ...
    return when (status) {
        TransactionType.CREDIT -> Color(0xFF66BB6A) //if (!isDark) Color(0xFFE6FFEC) else Color(0xFFC8E6C9)
        TransactionType.DEBIT -> Color(0xFF607D8B) //if (!isDark) Color(0xFFFBE6E7) else Color(0xFFFFCDD2)
    }
}
