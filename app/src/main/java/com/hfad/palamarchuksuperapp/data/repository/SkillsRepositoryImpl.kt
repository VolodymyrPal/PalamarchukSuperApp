...
class SkillsRepositoryImpl @Inject constructor(
    ...
    override fun getSkillsFromDB(): Flow<List<Skill>> {
        return skillsDao.getAllSkillsFromDB()
    }
...
class SkillsRepositoryImplForPreview : SkillRepository {
    override fun getSkillsFromDB(): Flow<List<Skill>> {
        ...
        val seven =
            Skill(name = "RxJava", description = "One, Two, Three", uuid = UUID.randomUUID())
        val eight = Skill(
            name = "To learn",
        ...
        val nine =
            Skill(name = "Recycler View", description = "One, Two, Three", uuid = UUID.randomUUID())
        val ten = Skill(name = "Project Pattern", description = "MVVM", uuid = UUID.randomUUID())
        val eleven =
            Skill(name = "Compose", description = "Composition tracing", uuid = UUID.randomUUID())
        val twelve = Skill(
